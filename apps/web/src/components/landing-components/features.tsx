            ...
            <div className="w-full flex flex-col justify-center items-center space-y-4">
                ...
                <div className="flex justify-center items-center space-x-4">
                    <div className="border px-4 py-4 rounded-lg max-w-96 min-h-44 flex flex-col justify-start items-start space-y-2">
                        <span className="text-blue-600 text-2xl"><BsStars /></span>
                    ...
                    <div className="border px-4 py-4 rounded-lg max-w-96 min-h-44 flex flex-col justify-start items-start space-y-2">
                        <span className="text-blue-600 text-2xl"><FaFilter /></span>
                    ...
                    <div className="border px-4 py-4 rounded-lg max-w-96 min-h-44 flex flex-col justify-start items-start space-y-2">
                        <span className="text-blue-600 text-2xl"><FaBookOpen /></span>
                ...
                <div className="flex justify-center items-center space-x-4">
                    <div className="border px-4 py-4 rounded-lg max-w-96 min-h-44 flex flex-col justify-start items-start space-y-2">
                        <span className="text-blue-600 text-2xl"><FaRobot /></span>
                    ...
                    <div className="border px-4 py-4 rounded-lg max-w-96 min-h-44 flex flex-col justify-start items-start space-y-2">
                        <span className="text-blue-600 text-2xl"><FaCode /></span>
                    ...
                    <div className="border px-4 py-4 rounded-lg max-w-96 min-h-44 flex flex-col justify-start items-start space-y-2">
                        <span className="text-blue-600 text-2xl"><FaChartLine /></span>
